...
After a while, though, limited resources also start to come into play. When calculating the change in the size of the population ($\Delta N$), we also need to take into account the maximum number of individuals the population can sustainably support, called the [carrying capacity]{.underline}, `K`.
...
1.  Large population
2.  Stable population (i.e., not declining or overshooting)
...
*Populations experiencing exponential growth not limited by resources.*
...
*The intrinsic growth rate is negative.*
...
Which population gets the largest? *Population D*
...
2.  Intrinsic growth (`r`) should not be negative
